(() => {
    ...
    const WORDS = [
        'lov u', 'lov u', '❤', 'love', 'te amo', 'je t\'aime',
        'forever', 'always', 'you', 'me & you', 'lov u', 'sweetheart'
    ];
    ...
    function startCardLoader() {
        ...
        const duration = 2400;
        const steps = [
            { threshold: 20, text: 'Loading Girlfriend Day...' },
            { threshold: 50, text: 'Compiling 3D coordinates...' },
            { threshold: 80, text: 'Generating love particles...' },
            { threshold: 95, text: 'Syncing Girlfriend Day rhythm...' },
    ...
    const letterText = "Dear Zalfia,\n\nHappy Girlfriend Day to the third most wonderful woman I've ever met, after my mother and my sister.\n\nHaving you in my life is one of the greatest blessings I could ever ask for. I hope your smile never fades, your days are always filled with happiness, and I can keep being the reason behind that beautiful smile.\n\nThank you for loving me, understanding me, and becoming a home for my heart. I love you more than words could ever express. 🤍";
